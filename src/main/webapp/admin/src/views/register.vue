<template>
  <div>
      ...
      <div class="login-form">
        <h1 class="h1">基于微信小程序的短视频系统注册</h1>
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='fabuzhe'" class="input-group">
			   <div class="label">发布账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.fabuzhanghao" class="input" type="text" placeholder="发布账号">
			   </div>
			 </div> -->
			<el-form-item label="发布账号" class="input" v-if="tableName=='fabuzhe'">
			  <el-input v-model="ruleForm.fabuzhanghao" autocomplete="off" placeholder="发布账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='fabuzhe'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<el-form-item label="密码" class="input" v-if="tableName=='fabuzhe'">
			  <el-input v-model="ruleForm.mima" autocomplete="off" placeholder="密码" type="password"#elsetype="text" />
			</el-form-item>
			<el-form-item label="确认密码" class="input" v-if="tableName=='fabuzhe'">
			  <el-input v-model="ruleForm.mima2" autocomplete="off" placeholder="确认密码" type="password"/>
			</el-form-item>

			<!-- <div v-if="tableName=='fabuzhe'" class="input-group">
			   <div class="label">发布姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.fabuxingming" class="input" type="text" placeholder="发布姓名">
			   </div>
			 </div> -->
			<el-form-item label="发布姓名" class="input" v-if="tableName=='fabuzhe'">
			  <el-input v-model="ruleForm.fabuxingming" autocomplete="off" placeholder="发布姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='fabuzhe'" class="input-group">
			   <div class="label">手机</div>
			   <div class="input-container">
			...
			<el-form-item label="手机" class="input" v-if="tableName=='fabuzhe'">
			  <el-input v-model="ruleForm.shouji" autocomplete="off" placeholder="手机"  />
			</el-form-item>
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((this.ruleForm.mima!=this.ruleForm.mima2) && `fabuzhe` == this.tableName){
	    this.$message.error(`两次密码输入不一致`);
	    return
      }
      if((!this.ruleForm.fabuxingming) && `fabuzhe` == this.tableName){
        this.$message.error(`发布姓名不能为空`);
        return
      }
